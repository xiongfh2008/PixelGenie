...
const HUGGINGFACE_MODELS = {
  ...
  aiDetection: {
    ...
    endpoint: 'https://router.huggingface.co/models/microsoft/resnet-50',
  ...
  watermarkRemoval: {
    ...
    endpoint: 'https://router.huggingface.co/models/microsoft/BiomedCLIP-PubMedBERT_256-v2',
  ...
  visualTranslation: {
    ...
    endpoint: 'https://router.huggingface.co/models/microsoft/trocr-base-printed',
  ...
  logoGeneration: {
    ...
    endpoint: 'https://router.huggingface.co/models/black-forest-labs/FLUX.1-schnell',
  ...
  imageCompression: {
    ...
    endpoint: 'https://router.huggingface.co/models/microsoft/resnet-18',
